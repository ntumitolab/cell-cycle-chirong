...
class CziDataset(FnetDataset):
    ...
    def __getitem__(self, index):
        ...
        '''
	The following commented part is amended by Chan-Ming
        ...
        if element[0] in time:
            ...
            im_out.append(czi.get_volume2(element['channel_signal']))
            if has_target:
                im_out.append(czi.get_volume2(element['channel_target']))
